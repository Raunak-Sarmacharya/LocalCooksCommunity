...
export class MemStorage implements IStorage {
  ...
  async createUser(insertUser: InsertUser & { googleId?: string, facebookId?: string, firebaseUid?: string }): Promise<User> {
    ...
    const user: User = {
      ...
      termsAccepted: (insertUser as any).termsAccepted !== undefined ? (insertUser as any).termsAccepted : false,
      termsAcceptedAt: (insertUser as any).termsAcceptedAt || null,
      termsVersion: (insertUser as any).termsVersion || null,
      updatedAt: new Date(),
