...
import { CustomAlertsProvider } from "@/components/ui/custom-alerts";
  ...
  return (
    <Suspense fallback={<LoadingSpinner />}>
      ...
      <Switch>
        ...
        {localePublicRoutes("/privacy", Privacy)}
        <Route path="/accept-terms" component={TermsAcceptanceScreen} />
        <Route path="/resources">
          {subdomain === 'kitchen' ? <KitchenResourcesPage /> : <ChefResourcesPage />}
        </Route>
        {localePublicRoutes("/resources", subdomain === 'kitchen' ? KitchenResourcesPage : ChefResourcesPage)}
