...
import { Plus, Trash2, Camera, ClipboardCheck, Lock, Eye, Info, Calendar, LogIn, LogOut, Upload, ArrowUpDown } from "@/components/ui/manager-icons";
            ...
            <StageCheckbox
              ...
              tooltip={
                item.requiredOnCheckin
                  ? mt("requiredWhenChefChecksIn") : mt("addToCheckInChecklist")
              }
              onToggle={() =>
                updateItem(item.id, {
                  ...item,
              ...
              accent="emerald"
              ariaLabel={tt("requiredOnCheckin")}
            />
          );
        },
        enableSorting: false,
            ...
            <StageCheckbox
              ...
              tooltip={
                item.requiredOnCheckout
                  ? mt("requiredWhenChefChecksOut") : mt("addToCheckoutChecklist")
              }
              onToggle={() =>
                updateItem(item.id, {
                  ...item,
              ...
              accent="primary"
              ariaLabel={tt("requiredOnCheckout")}
            />
          );
        },
        enableSorting: false,
