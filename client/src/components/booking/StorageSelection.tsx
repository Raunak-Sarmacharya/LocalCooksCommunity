...
export function StorageSelection({
  ...
  const storageTypeConfig = useMemo(
    () => ({
      freezer: {
        icon: Snowflake,
        label: t("storageSelFreezer"),
        iconBg: "bg-muted text-muted-foreground",
        badgeClass: "",
      },
      cold: {
        icon: Thermometer,
        label: t("storageSelRefrigerator"),
        iconBg: "bg-muted text-muted-foreground",
        badgeClass: "",
      },
      dry: {
        icon: Package,
        label: t("storageSelDryStorage"),
        iconBg: "bg-muted text-muted-foreground",
        badgeClass: "",
      },
    }),
  ...
  return (
    <div className="space-y-2">
      {activeListings.map((storage) => {
        ...
        const config =
          storageTypeConfig[storage.storageType] || storageTypeConfig.dry;
                  ...
                  <div className="flex items-center gap-2 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      {selectionPrice && (
                        <p className="text-xs text-muted-foreground">
                          {t("storageSelDaysTimesPrice", {
                            days: selectionPrice.days,
                            price: formatCents(selectionPrice.total),
                          })}
                        </p>
                      )}
                    </div>
