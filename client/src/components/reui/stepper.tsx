  ...
  return (
    ...
    >
      <div
        ...
        className={cn(
          // Explicit flex-1 (not not-last:) — some Tailwind builds drop not-last variants.
          "group/step flex min-w-0 flex-1 basis-0 items-center",
  ...
  return (
    <div
      ...
      className={cn(
        ...
        orientation === "horizontal"
          ? "mx-2 h-0.5 min-w-3 flex-1 self-center sm:mx-2.5"
          : "my-2 h-8 w-0.5 self-center",
        className
      )}
    />
  )
