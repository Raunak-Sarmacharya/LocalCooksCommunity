  ...
  return (
    <section id="about" className="py-12 md:py-16 px-4 scroll-mt-24 bg-gradient-to-b from-white to-gray-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5 pointer-events-none">
        ...
        <div className="absolute bottom-20 left-20 w-80 h-80 bg-[var(--color-gold)] rounded-full blur-3xl"></div>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center mb-12">
          ...
          >
            <div className="relative">
              ...
              <div className="relative bg-white p-8 md:p-10 rounded-2xl shadow-xl border border-gray-100 card-hover group overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <h3 className="text-2xl md:text-3xl font-bold text-[var(--color-text-primary)]">Our Mission</h3>
                  </div>
                  <p className="text-[var(--color-text-primary)] mb-5 leading-relaxed font-sans text-base md:text-lg">
                  ...
                  <p className="text-[var(--color-text-primary)] leading-relaxed font-sans text-base md:text-lg">
          ...
          <div className="space-y-6 md:space-y-8">
            {values.map((value, index) => (
              <motion.div
                key={index}
                className="flex gap-5 items-start group cursor-pointer p-4 rounded-xl hover:bg-white hover:shadow-lg transition-all duration-300"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
              ...
              >
                <div className={`flex-shrink-0 ${value.bgColor} w-14 h-14 md:w-16 md:h-16 rounded-xl shadow-lg flex items-center justify-center group-hover:scale-110 group-hover:shadow-xl transition-all duration-300`}>
                  {value.icon}
                </div>
                <div className="flex-1">
                  <h3 className="text-xl md:text-2xl font-bold mb-2 md:mb-3 text-[var(--color-text-primary)] group-hover:text-[var(--color-primary)] transition-colors duration-300">{value.title}</h3>
                  <p className="text-[var(--color-text-primary)] font-sans text-base md:text-lg leading-relaxed">{value.description}</p>
                </div>
              </motion.div>
            ))}
          </div>
