...
export default function KitchenResourcesPage_en() {
  const { t } = useTranslation("kitchen");
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <SEOHead
        title={t("seoKitchenResourcesTitle", "Kitchen Manager Resources — Operating a Shared Commercial Kitchen in Canada")}
        description={t("seoKitchenResourcesDesc", "Complete guide to licensing, insurance, risk assessment, operations, and pricing for shared commercial kitchens in Newfoundland & Labrador and across Canada.")}
