...
import { Building, Share2, CheckCircle, Clock, XCircle, AlertCircle, FileText, User } from "lucide-react";
...
export default function ShareProfile() {
  ...
  const handleShareProfile = async (kitchenId: number) => {
    try {
      await shareProfile.mutateAsync(kitchenId);
      toast({
        title: "Profile Shared",
        description: "Your profile has been shared with the kitchen. The manager will review it soon.",
      });
      refetch();
    } catch (error: any) {
      toast({
  ...
  const getProfileStatus = (kitchenId: number) => {
    const profile = profiles.find(p => p.kitchenId === kitchenId);
  ...
  if (isLoadingKitchens || isLoading) {
    return (
          ...
          <div className="container mx-auto px-4 py-8 max-w-7xl">
            <div className="bg-white border border-gray-200 rounded-xl p-12 text-center">
              ...
              <p className="text-gray-600 max-w-md mx-auto mb-6">
                You don't have access to any kitchens yet. Please contact an administrator to grant you access.
              </p>
              <Link href="/dashboard">
    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-1 pt-20 sm:pt-24 lg:pt-28 pb-12">
        <div className="container mx-auto px-4 py-8 max-w-7xl">
          {/* Header */}
          <div className="mb-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-2">Share Your Profile with Kitchens</h1>
            <p className="text-gray-600 text-lg">
              Share your application and documents with kitchen managers. They'll review your profile before approving you for bookings.
            </p>
          </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-800">
                  When you share your profile, kitchen managers will see your application details including your name, 
                  contact information, and all documents you uploaded during your application process.
                </p>
              </div>
            </div>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-4">
                    {!profile ? (
                      <Button
                        onClick={() => handleShareProfile(kitchen.id)}
