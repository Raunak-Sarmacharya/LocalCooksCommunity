...
function InfoCard({ children, variant = "info" }: { children: React.ReactNode; variant?: "info" | "warning" | "tip" }) {
  ...
  return (
    <Alert className="my-6 border bg-background">
...
export default function ChefResourcesPage_en() {
  const { t } = useTranslation("chef");
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <SEOHead
        title={t("seoChefResourcesTitle", "Chef Resources — Start Your Food Business in Canada")}
        description={t("seoChefResourcesDesc", "Complete guide to food safety certification, business registration, insurance, and licensing for food entrepreneurs in Newfoundland & Labrador and across Canada.")}
          ...
          <main className="flex-1 min-w-0 max-w-3xl py-8 lg:py-12 lg:border-l lg:pl-10">
            ...
            <div className="mb-10">
              ...
              <div className="flex flex-wrap gap-x-5 gap-y-2">
                {[
                  { icon: CheckCircle2, text: t("updatedFeb2026", "Updated February 2026") },
                  { icon: BookOpen, text: t("tenMinRead", "10-minute read") },
                ].map((item, i) => (
            ...
            <div className="prose-sm sm:prose prose-gray max-w-none prose-table:my-0 prose-thead:border-0 prose-tr:border-0 prose-th:p-0 prose-td:p-0">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
                <Card className="border shadow-none">
                  <CardHeader className="pb-2">
                    <CardTitle className="text-base flex items-center gap-2">
                      <CheckCircle2 className="h-4 w-4 text-success" /> Permitted (low-risk)
                    </CardTitle>
                  </CardHeader>
                  <CardContent className="pt-0">
                ...
                <Card className="border shadow-none">
                  <CardHeader className="pb-2">
                    <CardTitle className="text-base flex items-center gap-2">
                      <AlertTriangle className="h-4 w-4 text-destructive" /> Prohibited (high-risk)
                    </CardTitle>
                  </CardHeader>
                  <CardContent className="pt-0">
                    <ul className="text-sm text-muted-foreground space-y-1">
